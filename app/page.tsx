...
import { AssistantRuntimeProvider, ThreadPrimitive, ComposerPrimitive, useAui, AuiProvider, Tools, MessagePrimitive, } from "@assistant-ui/react";
import { useChatRuntime } from "./hooks/use-chat-runtime"; // 自定义聊天运行时钩子
import { toolkit } from "./lib/tools"; // 工具集合配置
        ...
        */}
        <ThreadPrimitive.Root>
          ...
          所有消息必须放在它里面，才能实现：
            ...
            3、流式输出时平滑跟随
          */}
          <ThreadPrimitive.Viewport style={{ height: "calc(100vh - 150px)", marginTop: "50px", overflowY: "auto" }}
